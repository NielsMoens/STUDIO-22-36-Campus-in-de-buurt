...
var Map = (0, react_1.forwardRef)(function (props, ref) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        Promise.resolve(mapLib || Promise.resolve().then(function () { return require('mapbox-gl'); }))
            ...
            if (mapboxgl.supported(props)) {
                ...
                mountedMapsContext === null || mountedMapsContext === void 0 ? void 0 : mountedMapsContext.onMapMount((0, create_ref_1.default)(mapbox, mapboxgl), props.id);
            }
            else {
    ...
    (0, react_1.useImperativeHandle)(ref, function () { return (0, create_ref_1.default)(mapInstance, contextValue.mapLib); }, [mapInstance]);
